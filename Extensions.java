...
/* The below static methods are available in this class
...
*  public static Boolean isDDMultiselect()

*  public static List<WebElement> GetDrpDwnValues

*  public static WebElement firstSelectedOption

*  public static List<WebElement> getAllSelectedOptions

*  public static void selectDDByIndex

*  public static void selectDDByValue

*  public static void selectDDByVisibleText

*  public static void deSelectDDByIndex

*  public static void deSelectDDByValue

*  public static void deSelectDDByVisibleText

*  public static void deSelectAllDDValue

*  public static void check check-box

*  public static void moveToElement

*  public static void Click

*  public static void assertTitleHard

*  public static void assertTitleSoft

*  public static void mouseHoverOnWebElement

*  public static void mouseClickOnWebElementAfterHovering

*  public static void mouseDoubleClick()

*  public static void mouseDoubleClickOnWebElement

*  public static void mouseRightClick()

 *  public static void mouseRightClickOnWebElement

*  public static void mouseRightClickOnWebElementAndSelectRequiredOption()

*  public static void dragAndDrop()

*  public static void mouseClickAndHold()

*  public static void mouseRelease()

*  public static void sendKeysToWebElement()
...
*  public static void switchToFrameByString()
...
*  public static List<WebElement> findAllLinkInPage(): Finds all links in the given page

*  public static ArrayList<Object> findAllBrokenLinkInPage():-Finds all broken links in the application which has a set broken link message.

 *  public static void getWindowScreenShot() : Will take the screen shot of the window like print screen
...

{
	...
	// Normal Wait:- This wait till the time in seconds provided while calling this
	// method.
	...
	// Implicit wait for page sync while it loads default time is 10 seconds
	...
	// Explicit wait for the page sync pages of wait for the specific element
	// visibility - default wait time is 10 seconds
...

	{
...

		{
			...
			WebDriverWait wait = new WebDriverWait(Browser.driver, 25);
	...
	// Returns the first Selected option (works for both single select and
	// Multi-select)
...

	{
...

		{
			...
			Reporter.log("Element with " + sourceElement + "or" + destinationElement
...

		{
			...
			Reporter.log("Element " + sourceElement + "or" + destinationElement + " was not found in DOM "
					+ e.getStackTrace(), true);
...

	{
		...
		File des = new File("C:\\Users\\prashanths\\git\\testRepo\\ScreenShots\\" + filename + ".jpeg");
	...
	public static void getWindowScreenShot(String name, String path)
	...
	public static void ScrollByPixel(int Xpixels, int YPixels) {
		JavascriptExecutor js = (JavascriptExecutor) Browser.driver;
		   // This  will scroll down the page by  given number of pixel vertical		
        js.executeScript("window.scrollBy(Xpixels,YPixels)");
    }

//	To scroll down the web page by the visibility of the element
	public static void ScrollByVisibleElement(WebElement ElementName) 
	{
		JavascriptExecutor js = (JavascriptExecutor) Browser.driver;
		WebElement Element = ElementName;
...
//	Horizontal scroll on the web page.
	 public static void ScrollHorizontally(WebElement ScrollElement) {
	        JavascriptExecutor js = (JavascriptExecutor) Browser.driver;
	 ...
	 {
		 String obtainedName = name[0];
		 return obtainedName;
	 }
	 public static void getALLAttributesOfWebElement(WebElement wb)
	 {
		 JavascriptExecutor executor = (JavascriptExecutor) Browser.driver;
		 Object aa=executor.executeScript("var items = {}; for (index = 0; index < arguments[0].attributes.length; ++index) { items[arguments[0].attributes[index].name] = arguments[0].attributes[index].value }; return items;", wb);
